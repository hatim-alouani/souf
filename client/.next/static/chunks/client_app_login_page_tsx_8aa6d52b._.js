...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await fetch("".concat(("TURBOPACK compile-time value", "https://sunfast-julee-moaningly.ngrok-free.dev"), "/auth/login"), {
                method: 'POST',
                headers: {
            ...
            if (!res.ok) {
                setStatus("❌ ".concat(data.error || 'Login failed.'));
            } else {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        className: "flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 via-indigo-100 to-gray-50 text-gray-800",
...
_s(LoginPage, "OsSenI/35VluPAeiNXD9jGbE2ZA=", false, function() {
    return [
