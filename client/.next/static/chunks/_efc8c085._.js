...
function ProfilePage() {
    ...
    // Simulated user info (replace later with real data from backend)
    const [user] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ...
        full_name: 'Hatim Alouani',
        company_name: 'A2X',
        user_persona: 'Manager',
        report_url: '/ai_audit_report.pdf'
    });
...
_s(ProfilePage, "Z+CUtooO54AolSvXK5SI5k8vYGk=", false, function() {
    return [
...
//# sourceMappingURL=_efc8c085._.js.map